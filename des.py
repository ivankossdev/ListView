...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_delete_row = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_delete_row.setGeometry(QtCore.QRect(190, 310, 41, 31))
        self.pushButton_delete_row.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/icon_delete_row.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_delete_row.setIcon(icon7)
        ...
        self.pushButton_edit.setGeometry(QtCore.QRect(190, 270, 41, 31))
        self.pushButton_edit.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/icon_edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
